...
class Libro_LenguajeController {
    index(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const libros_lenguajes = yield Database_1.default.query(`select * from Libros_Lenguajes`);
            return res.json(libros_lenguajes.recordset);
        });
    }
    indexTemporal(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const libros = yield Database_1.default.query(`exec Ver_Temporal_Lenguaje`);
    ...
    detail(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const libro_lenguaje = yield Database_1.default.query(`select * from Libros_Lenguajes where ISBN = ${id}`);
