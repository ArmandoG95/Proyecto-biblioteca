...
class Lenguaje_BoyceController {
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield Database_1.default.query(`exec Borrar_Temporal_Lenguaje @Id_Temporal = ${id}`);
    ...
    detail(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const lenguaje_temporal = yield Database_1.default.query(`exec Ver_Temporal_Detalle_Lenguaje @Id_Temporal = ${id}`);
